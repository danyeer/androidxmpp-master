...
/**
 * Interface to implement classes to listen for server events about privacy
 * communication. Listeners are registered with the {@link PrivacyListManager}.
 * 
...
public interface PrivacyListListener {
	 ...
	 * 
	 * @param listName
	 *            the name of the new or updated privacy list.
	 * @param listItem
	 *            the PrivacyItems that rules the list.
	 */
