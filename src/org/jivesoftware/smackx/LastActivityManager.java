 ...
 * <p>
 * 
 * LastActivity (JEP-012) based on the sending JID's type allows for retrieval
 * of:
 * <ol>
...
public class LastActivityManager {
	...
	private LastActivityManager(Connection connection) {
		...
		connection.addPacketListener(new PacketListener() {
			...
			@Override
			public void processPacket(Packet packet) {
				final LastActivity message = new LastActivity();
		...
		}, new AndFilter(new IQTypeFilter(IQ.Type.GET), new PacketTypeFilter(
				LastActivity.class)));
	}
