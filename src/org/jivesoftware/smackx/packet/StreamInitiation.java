...
public class StreamInitiation extends IQ {
	 ...
	 * <li>date: The last modification time of the file. This is specified using
	 * the DateTime profile as described in Jabber Date and Time Profiles.</li>
	...
	public static class File implements PacketExtension {
		...
		public String toXML() {
			...
			if (getName() != null) {
				buffer.append("name=\"")
						.append(StringUtils.escapeForXML(getName()))
						.append("\" ");
			}
			...
			if (getDate() != null) {
				buffer.append("date=\"")
						.append(StringUtils.formatXEP0082Date(date))
						.append("\" ");
			}
	...
	public String getChildElementXML() {
		...
		if (getType().equals(IQ.Type.SET)) {
			...
			final String fileXML = file.toXML();
			if (fileXML != null) {
				buf.append(fileXML);
			}
	...
	public void setFeatureNegotiationForm(final DataForm form) {
		featureNegotiation = new Feature(form);
	}
