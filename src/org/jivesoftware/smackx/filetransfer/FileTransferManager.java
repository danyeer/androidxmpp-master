...
public class FileTransferManager {
	...
	protected IncomingFileTransfer createIncomingFileTransfer(
		...
		final IncomingFileTransfer transfer = new IncomingFileTransfer(request,
	...
	protected void fireNewRequest(StreamInitiation initiation) {
		...
		final FileTransferRequest request = new FileTransferRequest(this,
				initiation);
	...
	protected void rejectIncomingFileTransfer(FileTransferRequest request) {
		final StreamInitiation initiation = request.getStreamInitiation();

		final IQ rejection = FileTransferNegotiator.createIQ(
