 ...
 * This class must be extended to implement an specific ad-hoc command. This
 * class provides some useful tools:
 * <ul>
 * <li>Node</li>
 * <li>Name</li>
 * <li>Session ID</li>
...
public abstract class LocalCommand extends AdHocCommand {
	...
	/**
	 * The time stamp of first invokation of the command. Used to implement the
	 * session timeout.
	 */
	...
	/**
	 * Decrease the current stage number. This is automatically handled and
	 ...
	 * stages of this action. This is checked when the first request is
	 * received, if the permission is grant then the requester will be able to
	 * execute all the stages of the command. It is not checked again during the
	 * execution.
	 * 
	 * @param jid
	...
	/**
	 * Increase the current stage number. This is automatically handled and
	 * should not be called.
	 * 
	 */
	void incrementStage() {
	...
	/**
	 * Sets the JID of the command host. This is automatically handled and
	 * should not be called.
	 * 
	 * @param ownerJID
	 *            the JID of the owner.
	 */
