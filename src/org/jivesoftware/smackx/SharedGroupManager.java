...
/**
 * A SharedGroupManager provides services for discovering the shared groups
...
public class SharedGroupManager {
	 ...
	 */
	public static List<String> getSharedGroups(Connection connection)
			throws XMPPException {
		// Discover the shared groups of the logged user
		final SharedGroupsInfo info = new SharedGroupsInfo();
