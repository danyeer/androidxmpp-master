...
/**
 * A TranscriptSearchManager helps to retrieve the form to use for searching
 * transcripts {@link #getSearchForm(String)} or to submit a search form and
 * return the results of the search {@link #submitSearch(String, Form)}.
 * 
...
public class TranscriptSearchManager {
	...
	public Form getSearchForm(String serviceJID) throws XMPPException {
		final TranscriptSearch search = new TranscriptSearch();
		...
		final TranscriptSearch response = (TranscriptSearch) collector
