 ...
 * {@link Socks5BytestreamSession} and {@link InBandBytestreamSession}.
 * 
...
public interface BytestreamSession {
	 ...
	 * <p>
	 * Closing the session will also close the input stream and the output
	 * stream associated to this session.
	 * 
	 * @throws IOException
	...
	/**
	 * Returns the timeout for read operations of the input stream associated
	 * with this session. 0 returns implies that the option is disabled (i.e.,
	 * timeout of infinity). Default is 0.
	 * 
	...
	/**
	 * Sets the specified timeout, in milliseconds. With this option set to a
	 * non-zero timeout, a read() call on the input stream associated with this
	 * session will block for only this amount of time. If the timeout expires,
	 * a java.net.SocketTimeoutException is raised, though the session is still
	 ...
	 * interpreted as an infinite timeout. Default is 0.
	 * 
	 * @param timeout
