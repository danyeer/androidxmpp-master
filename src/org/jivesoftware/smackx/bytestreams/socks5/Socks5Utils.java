...
class Socks5Utils {
	 ...
	 * 
	 * @param sessionID
	 *            for the SOCKS5 Bytestream
	 * @param initiatorJID
	 *            JID of the initiator of a SOCKS5 Bytestream
	 * @param targetJID
	 *            JID of the target of a SOCKS5 Bytestream
	 * @return SHA-1 digest of the given parameters
	 */
	public static String createDigest(String sessionID, String initiatorJID,
			String targetJID) {
	...
	/**
	 * Reads a SOCKS5 message from the given InputStream. The message can either
	 * be a SOCKS5 request message or a SOCKS5 response message.
	 * <p>
	 * (see <a href="http://tools.ietf.org/html/rfc1928">RFC1928</a>)
	 * 
	 * @param in
	 *            the DataInputStream to read the message from
	 ...
	 */
	public static byte[] receiveSocks5Message(DataInputStream in)
		...
		final int addressLength = header[4];

		final byte[] response = new byte[7 + addressLength];
