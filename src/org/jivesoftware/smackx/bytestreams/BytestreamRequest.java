...
/**
 * BytestreamRequest provides an interface to handle incoming bytestream
 * requests.
 * <p>
 * There are two implementations of the interface. See
 * {@link Socks5BytestreamRequest} and {@link InBandBytestreamRequest}.
 * 
...
public interface BytestreamRequest {
	...
	/**
	 * Accepts the bytestream open request and returns the session to
	 * send/receive data.
	 * 
	 * @return the session to send/receive data
	 * @throws XMPPException
	 *             if an error occurred while accepting the bytestream request
	...
	/**
	 * Rejects the bytestream request by sending a reject error to the
	 * initiator.
	 */
	public void reject();
