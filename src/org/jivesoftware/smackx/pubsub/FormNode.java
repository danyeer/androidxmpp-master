...
/**
 * Generic packet extension which represents any pubsub form that is parsed from
 * the incoming stream or being sent out to the server.
 * 
...
public class FormNode extends NodeExtension {
	 ...
	 *            The type of form being sent
	 * @param nodeId
	 *            The node the form is associated with
	 * @param submitForm
	 *            The form
	 */
