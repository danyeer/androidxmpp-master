...
/**
 * This enumeration represents all the fields of a node configuration form. This
 * enumeration is not required when using the {@link ConfigureForm} to configure
 * nodes, but may be helpful for generic UI's using only a {@link Form} for
 * configuration.
 * 
