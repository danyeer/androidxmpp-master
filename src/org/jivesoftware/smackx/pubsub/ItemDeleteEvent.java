...
public class ItemDeleteEvent extends SubscriptionEvent {
	 ...
	 *            The item ids of the items that were deleted.
	 * @param subscriptionIds
	 *            The subscriptions that match the event.
	 */
	public ItemDeleteEvent(String nodeId, List<String> deletedItemIds,
	...
	public String toString() {
		return getClass().getName() + "  [subscriptions: " + getSubscriptions()
				+ "], [Deleted Items: " + itemIds + ']';
	}
}
