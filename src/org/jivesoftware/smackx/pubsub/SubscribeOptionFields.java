...
/**
 * Defines the possible field options for a subscribe options form as defined by
 * <a href=
 * "http://xmpp.org/extensions/xep-0060.html#registrar-formtypes-subscribe"
 * >Section 16.4.2</a>.
 * 
...
public enum SubscribeOptionFields {
	...
	/**
	 * The minimum number of seconds between sending any two notifications
	 * digests
	 * 
	 * <p>
	 * <b>Value: int</b>
	...
	static public SubscribeOptionFields valueOfFromElement(String elementName) {
		final String portion = elementName.substring(elementName
				.lastIndexOf('#' + 1));
