...
public class SimplePayload implements PacketExtension {
	...
	/**
	 * Construct a <tt>SimplePayload</tt> object with the specified element
	 * name, namespace and content. The content must be well formed XML.
	 * 
	 * @param elementName
	 *            The root element name (of the payload)
	 * @param namespace
	 *            The namespace of the payload, null if there is none
	 * @param xmlPayload
	 *            The payload data
	 */
