...
public class Subscription extends NodeExtension {
	...
	/**
	 * Used to constructs a subscription request to the root node with the
	 * specified JID.
	 * 
	 * @param subscriptionJid
	 *            The subscriber JID
	 */
	...
	/**
	 * Used to constructs a subscription request to the specified node with the
	 * specified JID.
	 * 
	 * @param subscriptionJid
	 *            The subscriber JID
	 ...
	 * and JID. The server will have supplied the subscription id and current
	 * state.
	 * 
	 * @param jid
	 ...
	 */
	public Subscription(String jid, String nodeId, String subscriptionId,
			State state) {
	 ...
	 * Constructs a representation of a subscription reply to the specified node
	 * and JID. The server will have supplied the subscription id and current
	 * state and whether the subscription need to be configured.
	 * 
	 * @param jid
	 *            The JID the request was made under
	 * @param nodeId
	...
	/**
	 * This value is only relevant when the {@link #getState()} is
	 * {@link State#unconfigured}
	 * 
	...
	@Override
	public String toXML() {
		final StringBuilder builder = new StringBuilder("<subscription");
