 ...
 * One which has a <b>node</b> as an attribute. This class is used on its own as
 * well as a base class for many others, since the node is a central concept to
 * most pubsub functionality.
 * 
...
public class NodeExtension implements PacketExtension {
	...
	/**
	 * Constructs a <tt>NodeExtension</tt> with an element name specified by
	 * {@link PubSubElementType}.
	 * 
	 * @param elem
	...
	/**
	 * Constructs a <tt>NodeExtension</tt> with an element name specified by
	 * {@link PubSubElementType} and the specified node id.
	 * 
	 * @param elem
	 *            Defines the element name and namespace
	 * @param nodeId
